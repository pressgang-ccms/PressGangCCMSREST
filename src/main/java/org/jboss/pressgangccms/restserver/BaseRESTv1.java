...
public class BaseRESTv1
{
	...
	protected <T extends RESTBaseEntityV1<T, V>, U extends AuditedEntity<U>, V extends BaseRestCollectionV1<T, V>> V getJSONEntitiesUpdatedSince(final Class<V> collectionClass, final Class<U> type, final String idProperty, final RESTDataObjectFactory<T, U, V> dataObjectFactory, final String expandName, final String expand, final Date date)
	{
		return getEntitiesUpdatedSince(collectionClass, type, idProperty, dataObjectFactory, expandName, expand, JSON_URL, date);
	}

	protected <T extends RESTBaseEntityV1<T, V>, U extends AuditedEntity<U>, V extends BaseRestCollectionV1<T, V>> V getEntitiesUpdatedSince(final Class<V> collectionClass, final Class<U> type, final String idProperty, final RESTDataObjectFactory<T, U, V> dataObjectFactory, final String expandName, final String expand, final String dataType, final Date date)
	{
	...
	private <T extends RESTBaseEntityV1<T, V>, U, V extends BaseRestCollectionV1<T, V>> T createOrUdpateEntity(final Class<U> type, final T restEntity, final RESTDataObjectFactory<T, U, V> factory, final DatabaseOperation operation, final String baseUrl, final String dataType, final String expand) throws InternalProcessingException, InvalidParameterException
	{
	...
	protected <T extends RESTBaseEntityV1<T, V>, U extends AuditedEntity<U>, V extends BaseRestCollectionV1<T, V>> V createEntities(final Class<V> collectionClass, final Class<U> type, final BaseRestCollectionV1<T, V> entities, final RESTDataObjectFactory<T, U, V> factory, final String expandName, final String dataType, final String expand, final String baseUrl)
	{
	...
	protected <T extends RESTBaseEntityV1<T, V>, U extends AuditedEntity<U>, V extends BaseRestCollectionV1<T, V>> V updateEntities(final Class<V> collectionClass, final Class<U> type, final BaseRestCollectionV1<T, V> entities, final RESTDataObjectFactory<T, U, V> factory, final String expandName, final String dataType, final String expand, final String baseUrl)
	{
	...
	protected <T extends RESTBaseEntityV1<T, V>, U extends AuditedEntity<U>, V extends BaseRestCollectionV1<T, V>> V deleteEntities(final Class<V> collectionClass, final Class<U> type, final RESTDataObjectFactory<T, U, V> factory, final Set<String> ids, final String expandName, final String dataType, final String expand, final String baseUrl) throws InvalidParameterException, InternalProcessingException
	{
	 ...
	 */
	private <T extends RESTBaseEntityV1<T, V>, U extends AuditedEntity<U>, V extends BaseRestCollectionV1<T, V>> V createOrUdpateEntities(final Class<V> collectionClass, final Class<U> type, final RESTDataObjectFactory<T, U, V> factory, final BaseRestCollectionV1<T, V> entities, final DatabaseOperation operation, final String expandName, final String dataType, final String expand, final String baseUrl)
	{
	...
	protected <T extends RESTBaseEntityV1<T, V>, U extends AuditedEntity<U>, V extends BaseRestCollectionV1<T, V>> T getJSONResource(final Class<U> type, final RESTDataObjectFactory<T, U, V> dataObjectFactory, final Object id, final Number revision, final String expand) throws InvalidParameterException, InternalProcessingException
	{
	...
	protected <T extends RESTBaseEntityV1<T, V>, U extends AuditedEntity<U>, V extends BaseRestCollectionV1<T, V>> T getXMLResource(final Class<U> type, final RESTDataObjectFactory<T, U, V> dataObjectFactory, final Object id, final Number revision, final String expand) throws InvalidParameterException, InternalProcessingException
	{
		return getResource(type, dataObjectFactory, id, revision, expand, XML_URL);
	}

	private <T extends RESTBaseEntityV1<T, V>, U extends AuditedEntity<U>, V extends BaseRestCollectionV1<T, V>> T getResource(final Class<U> type, final RESTDataObjectFactory<T, U, V> dataObjectFactory, final Object id, final Number revision, final String expand, final String dataType) throws InvalidParameterException, InternalProcessingException
	{
		...
		try
		{
			...
			if (usingRevisions)
			{
				...
				/* Find the closest revision that is less than
				 * or equal to "revision" 
				 */
	...
	protected <T extends RESTBaseEntityV1<T, V>, U extends AuditedEntity<U>, V extends BaseRestCollectionV1<T, V>> V getXMLResources(final Class<V> collectionClass, final Class<U> type, final RESTDataObjectFactory<T, U, V> dataObjectFactory, final String expandName, final String expand) throws InvalidParameterException, InternalProcessingException
	{
		return getResources(collectionClass, type, dataObjectFactory, expandName, expand, XML_URL);
	}

	protected <T extends RESTBaseEntityV1<T, V>, U extends AuditedEntity<U>, V extends BaseRestCollectionV1<T, V>> V getJSONResources(final Class<V> collectionClass, final Class<U> type, final RESTDataObjectFactory<T, U, V> dataObjectFactory, final String expandName, final String expand) throws InvalidParameterException, InternalProcessingException
	{
		return getResources(collectionClass, type, dataObjectFactory, expandName, expand, JSON_URL);
	}

	protected <T extends RESTBaseEntityV1<T, V>, U extends AuditedEntity<U>, V extends BaseRestCollectionV1<T, V>> V getResources(final Class<V> collectionClass, final Class<U> type, final RESTDataObjectFactory<T, U, V> dataObjectFactory, final String expandName, final String expand, final String dataType) throws InvalidParameterException, InternalProcessingException
	{
		assert type != null : "The type parameter can not be null";
		assert dataObjectFactory != null : "The dataObjectFactory parameter can not be null";
	...
	protected <T extends RESTBaseEntityV1<T, V>, U extends AuditedEntity<U>, V extends BaseRestCollectionV1<T, V>> V getJSONTopicsFromQuery(final Class<V> collectionClass, final MultivaluedMap<String, String> queryParams, final FilterQueryBuilder filterQueryBuilder, final RESTDataObjectFactory<T, U, V> dataObjectFactory, final String expandName, final String expand) throws InternalProcessingException
	{
		return getTopicsFromQuery(collectionClass, queryParams, filterQueryBuilder, dataObjectFactory, expandName, expand, JSON_URL);
	}

	protected <T extends RESTBaseEntityV1<T, V>, U extends AuditedEntity<U>, V extends BaseRestCollectionV1<T, V>> V getTopicsFromQuery(final Class<V> collectionClass, final MultivaluedMap<String, String> queryParams, final FilterQueryBuilder filterQueryBuilder, final RESTDataObjectFactory<T, U, V> dataObjectFactory, final String expandName, final String expand, final String dataType) throws InternalProcessingException
	{
		assert dataObjectFactory != null : "The dataObjectFactory parameter can not be null";
