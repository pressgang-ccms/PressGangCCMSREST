    ...
    public RESTFilterV1 createRESTEntityFromDBEntityInternal(final Filter entity, final String baseUrl, final String dataType,
        ...
        if (revision == null && expand != null && expand.contains(RESTBaseEntityV1.REVISIONS_NAME)) {
            retValue.setRevisions(new RESTDataObjectCollectionFactory<RESTFilterV1, Filter, RESTFilterCollectionV1, RESTFilterCollectionItemV1>()
                    .create(RESTFilterCollectionV1.class, new FilterV1Factory(), entity,
        ...
        if (expand != null && expand.contains(RESTFilterV1.FILTER_CATEGORIES_NAME)) {
            retValue.setFilterCategories_OTM(new RESTDataObjectCollectionFactory<RESTFilterCategoryV1, FilterCategory, RESTFilterCategoryCollectionV1, RESTFilterCategoryCollectionItemV1>()
                    .create(RESTFilterCategoryCollectionV1.class, new FilterCategoryV1Factory(),
                            entity.getFilterCategoriesList(), RESTFilterV1.FILTER_CATEGORIES_NAME, dataType, expand, baseUrl,
                            false, entityManager));
        }
