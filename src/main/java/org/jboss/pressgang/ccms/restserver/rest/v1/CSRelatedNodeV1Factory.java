    ...
    public RESTCSRelatedNodeV1 createRESTEntityFromDBEntityInternal(final CSNodeToCSNode entity, final String baseUrl,
        ...
        if (revision == null && expand != null && expand.contains(RESTBaseEntityV1.REVISIONS_NAME)) {
            retValue.setRevisions(new RESTDataObjectCollectionFactory<RESTCSRelatedNodeV1, CSNodeToCSNode, RESTCSRelatedNodeCollectionV1, RESTCSRelatedNodeCollectionItemV1>()
                    .create(RESTCSRelatedNodeCollectionV1.class, new CSRelatedNodeV1Factory(), entity,
                            EnversUtilities.getRevisions(entityManager, entity), RESTBaseEntityV1.REVISIONS_NAME, dataType,
                            expand, baseUrl, entityManager));
        }

        // PARENT
        if (expandParentReferences && expand != null && expand.contains(RESTCSRelatedNodeV1.PARENT_NAME)
                && entity.getRelatedNode().getParent() != null) {
        ...
        // CONTENT SPEC
        if (expand != null && expand.contains(RESTCSRelatedNodeV1.CONTENT_SPEC_NAME)
                && entity.getRelatedNode().getContentSpec() != null)
        ...
        if (expand != null && expand.contains(RESTCSRelatedNodeV1.RELATED_FROM_NAME)) {
            retValue.setRelatedFromNodes(new RESTDataObjectCollectionFactory<RESTCSRelatedNodeV1, CSNodeToCSNode, RESTCSRelatedNodeCollectionV1, RESTCSRelatedNodeCollectionItemV1>()
                    .create(RESTCSRelatedNodeCollectionV1.class, new CSRelatedNodeV1Factory(), entity.getRelatedNode()
                            .getRelatedFromNodesList(), RESTCSRelatedNodeV1.RELATED_FROM_NAME, dataType, expand, baseUrl,
                            entityManager));
        }
        ...
        if (expand != null && expand.contains(RESTCSRelatedNodeV1.RELATED_TO_NAME)) {
            retValue.setRelatedToNodes(new RESTDataObjectCollectionFactory<RESTCSRelatedNodeV1, CSNodeToCSNode, RESTCSRelatedNodeCollectionV1, RESTCSRelatedNodeCollectionItemV1>()
                    .create(RESTCSRelatedNodeCollectionV1.class, new CSRelatedNodeV1Factory(), entity.getRelatedNode()
                            .getRelatedToNodesList(), RESTCSRelatedNodeV1.RELATED_TO_NAME, dataType, expand, baseUrl,
                            entityManager));
        }
        ...
        if (expand != null && expand.contains(RESTCSRelatedNodeV1.TRANSLATED_STRINGS_NAME)) {
            retValue.setTranslatedStrings_OTM(new RESTDataObjectCollectionFactory<RESTCSTranslatedStringV1, CSTranslatedString, RESTCSTranslatedStringCollectionV1, RESTCSTranslatedStringCollectionItemV1>()
                    .create(RESTCSTranslatedStringCollectionV1.class, new CSTranslatedStringV1Factory(), entity
                            .getRelatedNode().getCSTranslatedStringsList(), RESTCSRelatedNodeV1.TRANSLATED_STRINGS_NAME,
                            dataType, expand, baseUrl, false, entityManager));
        }
        ...
        if (expand != null && expand.contains(RESTCSRelatedNodeV1.PROPERTIES_NAME)) {
            retValue.setProperties(new RESTDataObjectCollectionFactory<RESTAssignedPropertyTagV1, CSNodeToPropertyTag, RESTAssignedPropertyTagCollectionV1, RESTAssignedPropertyTagCollectionItemV1>()
                    .create(RESTAssignedPropertyTagCollectionV1.class, new CSNodePropertyTagV1Factory(), entity
                            .getRelatedNode().getCSNodeToPropertyTagsList(), RESTCSRelatedNodeV1.PROPERTIES_NAME, dataType,
