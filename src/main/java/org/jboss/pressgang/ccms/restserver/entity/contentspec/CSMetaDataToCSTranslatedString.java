...
@Table(name = "CSMetaDataToCSTranslatedString", uniqueConstraints = @UniqueConstraint(columnNames = { "ContentSpecMetaDataID", "ContentSpecTranslatedStringID" }))
public class CSMetaDataToCSTranslatedString extends AuditedEntity<CSMetaDataToCSTranslatedString> implements java.io.Serializable
{
    ...
    {
        super(CSMetaDataToCSTranslatedString.class);
    }
