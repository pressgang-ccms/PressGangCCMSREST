...
insert into SCOPE (SCOPE_ID, SCOPE_NAME) values (-3, 'PERFORM_SUPER_USER_ACTION')
...
insert into TOKEN_GRANT (TOKEN_GRANT_ID, ACCESS_TOKEN, REFRESH_TOKEN, ACCESS_TOKEN_EXPIRES, ACCESS_TOKEN_EXPIRY, CLIENT_ID, USER_ID, TOKEN_GRANT_CURRENT, TOKEN_GRANT_TIMESTAMP) values (-2, 'expired_access_token', 'refresh_token', true, '1', -1, -1, true, TIMESTAMPADD('SECOND', -1, CURRENT_TIMESTAMP()))
insert into TOKEN_GRANT (TOKEN_GRANT_ID, ACCESS_TOKEN, REFRESH_TOKEN, ACCESS_TOKEN_EXPIRES, ACCESS_TOKEN_EXPIRY, CLIENT_ID, USER_ID, TOKEN_GRANT_CURRENT, TOKEN_GRANT_TIMESTAMP) values (-3, 'noncurrent_access_token', 'refresh_token', true, '3600', -1, -1, false, CURRENT_TIMESTAMP())
...
insert into TOKEN_GRANT_SCOPE (TOKEN_GRANT_ID, SCOPE_ID) values (-2, -1)
insert into TOKEN_GRANT_SCOPE (TOKEN_GRANT_ID, SCOPE_ID) values (-3, -1)
...
insert into RS_ENDPOINT (ENDPOINT_ID, ENDPOINT_URL, ENDPOINT_METHOD, URL_REGEX) values (-2, 'https://localhost:8443/testauthserver/rest/auth/user/makeIdentityPrimary', 'GET', false)
insert into RS_ENDPOINT (ENDPOINT_ID, ENDPOINT_URL, ENDPOINT_METHOD, URL_REGEX) values (-3, 'https://localhost:8443/testauthserver/rest/auth/user/queryIdentity', 'GET', false)
insert into RS_ENDPOINT (ENDPOINT_ID, ENDPOINT_URL, ENDPOINT_METHOD, URL_REGEX) values (-4, 'https://localhost:8443/testauthserver/rest/auth/user/queryUser', 'GET', false)
insert into RS_ENDPOINT (ENDPOINT_ID, ENDPOINT_URL, ENDPOINT_METHOD, URL_REGEX) values (-5, 'https://localhost:8443/testauthserver/rest/auth/invalidate', 'GET', false)
