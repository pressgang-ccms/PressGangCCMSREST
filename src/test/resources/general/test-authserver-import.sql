...
insert into TOKEN_GRANT (TOKEN_GRANT_ID, ACCESS_TOKEN, REFRESH_TOKEN, ACCESS_TOKEN_EXPIRES, ACCESS_TOKEN_EXPIRY, CLIENT_ID, USER_ID, TOKEN_GRANT_CURRENT, TOKEN_GRANT_TIMESTAMP) values (-3, 'old_access_token', 'refresh_token', true, '3600', -1, -1, false, CURRENT_TIMESTAMP())
